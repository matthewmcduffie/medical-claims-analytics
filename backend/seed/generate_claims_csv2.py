...
# Keep the same seed to preserve realistic distributions
# while still producing different IDs
random.seed(42)

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, "../.."))

# IMPORTANT: new output file
OUTPUT_PATH = os.path.join(PROJECT_ROOT, "data", "claims_100k_batch2.csv")

# Batch sizing
TOTAL_CLAIMS = 100_000

# IMPORTANT: offset to avoid claim_id collisions
START_ID = 100_001
...
print(f"Generated {TOTAL_CLAIMS} claims to {OUTPUT_PATH}")
